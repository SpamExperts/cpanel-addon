 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamFilter_Validate_NotIdentical extends Zend_Validate_Abstract
{
    /**
     * Error codes
     * @const string
     */
    const IS_IDENTICAL      = 'isIdentical';
    ...
    protected $_messageTemplates = array(
        self::IS_IDENTICAL      => "The two given tokens should not match",
