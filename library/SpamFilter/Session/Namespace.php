 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamFilter_Session_Namespace extends Zend_Session_Abstract implements IteratorAggregate
{
    ...
    {
        parent::$_writable = true;// temporary fix
        parent::$_readable = true;// temporary fix
